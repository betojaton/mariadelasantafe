...
class __TwigTemplate_c2412eb19fe72ad092104e787907383e6b52250d27f7d6474bb1b466da7a1a60 extends \Twig\Template
{
            ...
            if (($this->getAttribute(($context["page"] ?? null), "summary", []) != $this->getAttribute(($context["page"] ?? null), "content", []))) {
              ...
              ";
                ...
                if (($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", []), "continue_link", []) === true)) {
                    ...
                    echo $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "THEME_QUARK.BLOG.ITEM.CONTINUE_READING");
                    echo "</a>
              ";
                }
                // line 51
...
{% endif %}
", "partials/blog-list-item.html.twig", "C:\\xampp\\htdocs\\mariadelasantafe_org_ar\\grav-admin\\user\\themes\\quark-open-publishing\\templates\\partials\\blog-list-item.html.twig");
    }
}
