...
class __TwigTemplate_34b970dc3d1b6c14f8eef4b764bfbf39d4d10ad07137181ecaa91bf5d2ec154a extends \Twig\Template
{
    ...
    <form name=\"search\" data-simplesearch-form>
        ...
        echo "            required
            placeholder=\"";
        // line 11
        echo $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->translate($this->env, "PLUGIN_SIMPLESEARCH.SEARCH_PLACEHOLDER");
        echo "\"
            value=\"";
        // line 12
        ...
        if ($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", []), "simplesearch", []), "display_button", [])) {
            ...
            echo "            <button type=\"submit\" class=\"search-submit\">
                <img src=\"";
            // line 19
            echo $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->urlFunc("plugin://simplesearch/assets/search.svg");
            echo "\"/>
            </button>
        ";
        }
...
", "partials/simplesearch_searchbox.html.twig", "C:\\xampp\\htdocs\\mariadelasantafe_org_ar\\grav-admin\\user\\themes\\quark-open-publishing\\templates\\partials\\simplesearch_searchbox.html.twig");
    }
}
