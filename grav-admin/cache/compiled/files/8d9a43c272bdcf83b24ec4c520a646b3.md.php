...
return [
    ...
    'filename' => 'C:/xampp/htdocs/mariadelasantafe_org_ar/grav-admin/user/pages/02.standardpage/default.md',
    'modified' => 1697128334,
    'size' => 5004,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Standard Page\'
hide_git_sync_repo_link: false',
        'markdown' => 'This is an example **standard** page, where content from one single page is displayed. This page also shows how to add classes to Markdown images for floating images left or right, with and without captions.
