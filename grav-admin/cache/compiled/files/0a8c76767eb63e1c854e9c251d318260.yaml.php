...
return [
    ...
    'filename' => 'C:/xampp/htdocs/mariadelasantafe_org_ar/grav-admin/user/themes/mytheme/blueprints.yaml',
    'modified' => 1702500307,
    'size' => 13343,
    'data' => [
        'name' => 'Tema Custom',
        'version' => '1.1.0',
        'description' => 'Customizacion del tema Quark Open Publishing',
        'icon' => 'crosshairs',
        'author' => [
            'name' => 'betojaton',
            'email' => 'hol@betojaton.com',
            'url' => 'https://betojaton.com'
        ],
        'form' => [
            'validation' => 'loose',
            'fields' => [
