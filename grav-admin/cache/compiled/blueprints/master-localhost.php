...
return [
    ...
    'timestamp' => 1703278632,
    'checksum' => '3c6f9d8aec04c8ff9a760d2f3d808abe',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/directorylisting' => [
                'file' => 'user/plugins/directorylisting/blueprints.yaml',
                'modified' => 1672675106
            ],
            'plugins/email' => [
            ...
            'plugins/facebook-feed' => [
                'file' => 'user/plugins/facebook-feed/blueprints.yaml',
                'modified' => 1604470336
            ],
            'plugins/feed' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.aboutme.show_title' => [
                ...
                'name' => 'plugins.aboutme.show_title',
                'validation' => 'strict'
            ],
            ...
            'plugins.aboutme.social_pages.pages.facebook.icon_type' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.aboutme.social_pages.pages.facebook.icon_type',
                'validation' => 'strict'
            ],
            ...
            'plugins.aboutme.social_pages.pages.twitter.icon_type' => [
                'type' => 'toggle',
                'label' => 'PLUGIN_ABOUTME.SOCIAL_PAGES_TYPES.ICON_TYPE',
                'highlight' => 'b',
                'default' => 'b',
                ...
                'name' => 'plugins.aboutme.social_pages.pages.twitter.icon_type',
                'validation' => 'strict'
            ],
            ...
            'plugins.aboutme.social_pages.pages.github.icon_type' => [
                'type' => 'toggle',
                'label' => 'PLUGIN_ABOUTME.SOCIAL_PAGES_TYPES.ICON_TYPE',
                'highlight' => 'b',
                'default' => 'b',
                ...
                'name' => 'plugins.aboutme.social_pages.pages.github.icon_type',
                'validation' => 'strict'
            ],
            ...
            'plugins.aboutme.social_pages.pages.linkedin.icon_type' => [
                'type' => 'toggle',
                'label' => 'PLUGIN_ABOUTME.SOCIAL_PAGES_TYPES.ICON_TYPE',
                'highlight' => 'b',
                'default' => 'b',
                ...
                'name' => 'plugins.aboutme.social_pages.pages.linkedin.icon_type',
                'validation' => 'strict'
            ],
            ...
            'plugins.aboutme.social_pages.pages.instagram.icon_type' => [
                'type' => 'toggle',
                'label' => 'PLUGIN_ABOUTME.SOCIAL_PAGES_TYPES.ICON_TYPE',
                'highlight' => 'b',
                'default' => 'b',
                ...
                'name' => 'plugins.aboutme.social_pages.pages.instagram.icon_type',
                'validation' => 'strict'
            ],
            ...
            'plugins.directorylisting.enabled' => [
                'type' => 'toggle',
                'label' => 'Plugin Status',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'plugins.directorylisting.enabled',
                'validation' => 'loose'
            ],
            'plugins.directorylisting.level' => [
                'type' => 'text',
                'label' => 'Level',
                ...
                'name' => 'plugins.directorylisting.level',
                'validation' => 'loose'
            ],
            'plugins.directorylisting.max_depth' => [
                'type' => 'range',
                'label' => 'Maximum Level',
                ...
                'name' => 'plugins.directorylisting.max_depth',
                'validation' => 'loose'
            ],
            'plugins.directorylisting.showfiles' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.directorylisting.showfiles',
                'validation' => 'loose'
            ],
            'plugins.directorylisting.links' => [
                'type' => 'toggle',
                'label' => 'Link to files',
                ...
                'name' => 'plugins.directorylisting.links',
                'validation' => 'loose'
            ],
            'plugins.directorylisting.builtin_css' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.directorylisting.builtin_css',
                'validation' => 'loose'
            ],
            'plugins.directorylisting.builtin_js' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.directorylisting.builtin_js',
                'validation' => 'loose'
            ],
            'plugins.directorylisting.exclude_main' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.directorylisting.exclude_main',
                'validation' => 'loose'
            ],
            'plugins.directorylisting.exclude_modular' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.directorylisting.exclude_modular',
                'validation' => 'loose'
            ],
            'plugins.directorylisting.order' => [
                'type' => '_parent',
                'name' => 'plugins.directorylisting.order',
                'form_field' => false
            ],
            'plugins.directorylisting.order.by' => [
                'type' => 'select',
                'size' => 'medium',
                'classes' => 'fancy',
                'label' => 'Order Type',
                ...
                'name' => 'plugins.directorylisting.order.by',
                'validation' => 'loose'
            ],
            'plugins.directorylisting.order.dir' => [
                'type' => 'toggle',
                'label' => 'Order Direction',
                'highlight' => 'asc',
                'default' => 'desc',
                ...
                'name' => 'plugins.directorylisting.order.dir',
                'validation' => 'loose'
            ],
            'plugins.directorylisting.include_additional' => [
                'type' => 'selectize',
                ...
                'name' => 'plugins.directorylisting.include_additional',
                'validation' => 'loose'
            ],
            'plugins.directorylisting.exclude_additional' => [
                'type' => 'selectize',
                ...
                'name' => 'plugins.directorylisting.exclude_additional',
                'validation' => 'loose'
            ],
            'plugins.email' => [
                'type' => '_root',
            ...
            'plugins.facebook-feed.enabled' => [
                ...
                'name' => 'plugins.facebook-feed.enabled',
                'validation' => 'loose'
            ],
            'plugins.facebook-feed.fb_settings' => [
                'type' => '_parent',
                'name' => 'plugins.facebook-feed.fb_settings',
                'form_field' => false
            ],
            'plugins.facebook-feed.fb_settings.enableCSS' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.facebook-feed.fb_settings.enableCSS',
                'validation' => 'loose'
            ],
            'plugins.facebook-feed.fb_settings.page_id' => [
                'type' => 'text',
                'size' => 'small',
                ...
                'name' => 'plugins.facebook-feed.fb_settings.page_id',
                'validation' => 'loose'
            ],
            'plugins.facebook-feed.fb_settings.token' => [
                'type' => 'text',
                'size' => 'large',
                ...
                'name' => 'plugins.facebook-feed.fb_settings.token',
                'validation' => 'loose'
            ],
            'plugins.facebook-feed.fb_settings.limit' => [
                'type' => 'text',
                'size' => 'small',
                ...
                'name' => 'plugins.facebook-feed.fb_settings.limit',
                'validation' => 'loose'
            ],
            'plugins.facebook-feed.fb' => [
                'type' => '_parent',
                'name' => 'plugins.facebook-feed.fb',
                'form_field' => false
            ],
            'plugins.facebook-feed.fb.headline' => [
                'type' => 'text',
                'size' => 'medium',
                ...
                'name' => 'plugins.facebook-feed.fb.headline',
                'validation' => 'loose'
            ],
            'plugins.facebook-feed.fb.postLinkTitle' => [
                'type' => 'text',
                'size' => 'medium',
                ...
                'name' => 'plugins.facebook-feed.fb.postLinkTitle',
                'validation' => 'loose'
            ],
            'plugins.facebook-feed.fb.postLinkAlt' => [
                'type' => 'text',
                'size' => 'medium',
                ...
                'name' => 'plugins.facebook-feed.fb.postLinkAlt',
                'validation' => 'loose'
            ],
            'plugins.facebook-feed.fb.mainLinkTitle' => [
                'type' => 'text',
                'size' => 'medium',
                ...
                'name' => 'plugins.facebook-feed.fb.mainLinkTitle',
                'validation' => 'loose'
            ],
            'plugins.facebook-feed.fb.mainLinkAlt' => [
                'type' => 'text',
                'size' => 'medium',
                ...
                'name' => 'plugins.facebook-feed.fb.mainLinkAlt',
                'validation' => 'loose'
            ],
            'plugins.facebook-feed.fb.imgFallback' => [
                'array' => true,
                'media_field' => true,
                'validate' => [
                    'type' => 'ignore'
                ...
                'name' => 'plugins.facebook-feed.fb.imgFallback',
                'validation' => 'loose'
            ],
            'plugins.facebook-feed.fb.imgFallbackSelect' => [
                ...
                'name' => 'plugins.facebook-feed.fb.imgFallbackSelect',
                'validation' => 'loose'
            ],
            'plugins.facebook-feed.fb.imgFallbackAlt' => [
                'type' => 'text',
                'size' => 'medium',
                ...
                'name' => 'plugins.facebook-feed.fb.imgFallbackAlt',
                'validation' => 'loose'
            ],
            'plugins.facebook-feed.fb.imgFallbackTitle' => [
                'type' => 'text',
                'size' => 'medium',
                ...
                'name' => 'plugins.facebook-feed.fb.imgFallbackTitle',
                'validation' => 'loose'
            ],
            'plugins.feed' => [
                'type' => '_root',
...
',
            ...
            'plugins.social-media-links.social_pages.pages.youtube' => [
                'type' => '_parent',
                'name' => 'plugins.social-media-links.social_pages.pages.youtube',
                'form_field' => false
            ],
            'plugins.social-media-links.social_pages.pages.youtube.icon' => [
                'type' => 'text',
                'size' => 'small',
                'label' => 'Font Awesome Icon',
                'default' => 'Youtube',
                'validate' => NULL,
                'name' => 'plugins.social-media-links.social_pages.pages.youtube.icon',
                'validation' => 'strict'
            ],
            'plugins.social-media-links.social_pages.pages.youtube.url' => [
                'type' => 'url',
                'label' => 'Your Yyoutube Profile URL',
                'validate' => NULL,
                'name' => 'plugins.social-media-links.social_pages.pages.youtube.url',
                'validation' => 'strict'
            ],
            'plugins.social-media-links.social_pages.pages.youtube.title' => [
                'type' => 'text',
                'label' => 'Title when icon hovered (optional)',
                'default' => 'youtube',
                'validate' => NULL,
                'name' => 'plugins.social-media-links.social_pages.pages.youtube.title',
                'validation' => 'strict'
            ],
            'plugins.social-media-links.social_pages.pages.youtube.position' => [
                'type' => 'text',
                'size' => 'x-small',
                'label' => 'Position',
                'default' => 5,
                'validate' => NULL,
                'name' => 'plugins.social-media-links.social_pages.pages.youtube.position',
                'validation' => 'strict'
            ],
            'plugins.social-media-links.social_pages.pages.telegram' => [
                'type' => '_parent',
                'name' => 'plugins.social-media-links.social_pages.pages.telegram',
                'form_field' => false
            ],
            'plugins.social-media-links.social_pages.pages.telegram.icon' => [
                'type' => 'text',
                'size' => 'small',
                'label' => 'Font Awesome Icon',
                'default' => 'Telegram',
                'validate' => NULL,
                'name' => 'plugins.social-media-links.social_pages.pages.telegram.icon',
                'validation' => 'strict'
            ],
            'plugins.social-media-links.social_pages.pages.telegram.url' => [
                'type' => 'url',
                'label' => 'Your Telegram Profile URL',
                'validate' => NULL,
                'name' => 'plugins.social-media-links.social_pages.pages.telegram.url',
                'validation' => 'strict'
            ],
            'plugins.social-media-links.social_pages.pages.telegram.title' => [
                'type' => 'text',
                'label' => 'Title when icon hovered (optional)',
                'default' => 'Telegram',
                'validate' => NULL,
                'name' => 'plugins.social-media-links.social_pages.pages.telegram.title',
                'validation' => 'strict'
            ],
            'plugins.social-media-links.social_pages.pages.telegram.position' => [
                'type' => 'text',
                'size' => 'x-small',
                'label' => 'Position',
                'default' => 6,
                'validate' => NULL,
                'name' => 'plugins.social-media-links.social_pages.pages.telegram.position',
                'validation' => 'strict'
            ],
            'plugins.taxonomylist' => [
                'type' => '_root',
            ...
            'themes.mytheme.production-mode' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.mytheme.production-mode',
                'validation' => 'loose'
            ],
            'themes.mytheme.grid-size' => [
                'type' => 'select',
                'label' => 'Grid size',
                'size' => 'small',
                'options' => [
                ...
                'name' => 'themes.mytheme.grid-size',
                'validation' => 'loose'
            ],
            'themes.mytheme.custom_logo' => [
                'array' => true,
                'media_field' => true,
                'validate' => [
                    'type' => 'ignore'
                ...
                'name' => 'themes.mytheme.custom_logo',
                'validation' => 'loose'
            ],
            'themes.mytheme.custom_logo_mobile' => [
                'array' => true,
                'media_field' => true,
                'validate' => [
                    'type' => 'ignore'
                ...
                'name' => 'themes.mytheme.custom_logo_mobile',
                'validation' => 'loose'
            ],
            'themes.mytheme.header-fixed' => [
                'type' => 'toggle',
                'label' => 'Fixed header',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.mytheme.header-fixed',
                'validation' => 'loose'
            ],
            'themes.mytheme.header-animated' => [
                'type' => 'toggle',
                'label' => 'Animated',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.mytheme.header-animated',
                'validation' => 'loose'
            ],
            'themes.mytheme.header-dark' => [
                'type' => 'toggle',
                'label' => 'Dark Style',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.mytheme.header-dark',
                'validation' => 'loose'
            ],
            'themes.mytheme.header-transparent' => [
                'type' => 'toggle',
                'label' => 'Transparent',
                'highlight' => 0,
                'default' => 1,
                ...
                'name' => 'themes.mytheme.header-transparent',
                'validation' => 'loose'
            ],
            'themes.mytheme.sticky-footer' => [
                'type' => 'toggle',
                'label' => 'Sticky footer',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.mytheme.sticky-footer',
                'validation' => 'loose'
            ],
            'themes.mytheme.blog-page' => [
                'type' => 'text',
                'label' => 'Blog Page',
                'size' => 'medium',
                'default' => '/blog',
                'name' => 'themes.mytheme.blog-page',
                'validation' => 'loose'
            ],
            'themes.mytheme.blog_page_hero_classes' => [
                'type' => 'text',
                'label' => 'Hero Classes',
                'markdown' => true,
                ...
                'name' => 'themes.mytheme.blog_page_hero_classes',
                'validation' => 'loose'
            ],
            'themes.mytheme.spectre' => [
                'type' => '_parent',
                'name' => 'themes.mytheme.spectre',
                'form_field' => false
            ],
            'themes.mytheme.spectre.exp' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.mytheme.spectre.exp',
                'validation' => 'loose'
            ],
            'themes.mytheme.spectre.icons' => [
                'type' => 'toggle',
                'label' => 'Icons CSS',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.mytheme.spectre.icons',
                'validation' => 'loose'
            ],
            ...
            'themes.mytheme.menu.*.text' => [
                'type' => 'text',
                'label' => 'Text',
                'description' => 'Text label for menu item.',
                'name' => 'themes.mytheme.menu.*.text',
                'validation' => 'loose'
            ],
            'themes.mytheme.menu.*.icon' => [
                'type' => 'text',
                'label' => 'Icon',
                'description' => 'Font Awesome icon for menu item.',
                'name' => 'themes.mytheme.menu.*.icon',
                'validation' => 'loose'
            ],
            'themes.mytheme.menu.*.url' => [
                'type' => 'text',
                'label' => 'URL',
                'description' => 'URL for menu item.',
                'name' => 'themes.mytheme.menu.*.url',
                'validation' => 'loose'
            ],
            'themes.mytheme.menu.*.target' => [
                'type' => 'select',
                'label' => 'Target',
                'default' => '_self',
                'size' => 'medium',
                ...
                'name' => 'themes.mytheme.menu.*.target',
                'validation' => 'loose'
            ],
        ...
        'nested' => [
            ...
            'plugins' => [
                'aboutme' => [
                    ...
                    'show_title' => 'plugins.aboutme.show_title',
                    ...
                    'social_pages' => [
                        ...
                        'pages' => [
                            'facebook' => [
                                'icon_type' => 'plugins.aboutme.social_pages.pages.facebook.icon_type',
                            ...
                            'twitter' => [
                                'icon_type' => 'plugins.aboutme.social_pages.pages.twitter.icon_type',
                            ...
                            'github' => [
                                'icon_type' => 'plugins.aboutme.social_pages.pages.github.icon_type',
                            ...
                            'linkedin' => [
                                'icon_type' => 'plugins.aboutme.social_pages.pages.linkedin.icon_type',
                            ...
                            'instagram' => [
                                'icon_type' => 'plugins.aboutme.social_pages.pages.instagram.icon_type',
                ...
                'directorylisting' => [
                    'enabled' => 'plugins.directorylisting.enabled',
                    'level' => 'plugins.directorylisting.level',
                    'max_depth' => 'plugins.directorylisting.max_depth',
                    'showfiles' => 'plugins.directorylisting.showfiles',
                    'links' => 'plugins.directorylisting.links',
                    'builtin_css' => 'plugins.directorylisting.builtin_css',
                    'builtin_js' => 'plugins.directorylisting.builtin_js',
                    'exclude_main' => 'plugins.directorylisting.exclude_main',
                    'exclude_modular' => 'plugins.directorylisting.exclude_modular',
                    'order' => [
                        'by' => 'plugins.directorylisting.order.by',
                        'dir' => 'plugins.directorylisting.order.dir'
                    ],
                    'include_additional' => 'plugins.directorylisting.include_additional',
                    'exclude_additional' => 'plugins.directorylisting.exclude_additional'
                ],
                'email' => [
                ...
                'facebook-feed' => [
                    'enabled' => 'plugins.facebook-feed.enabled',
                    'fb_settings' => [
                        'enableCSS' => 'plugins.facebook-feed.fb_settings.enableCSS',
                        'page_id' => 'plugins.facebook-feed.fb_settings.page_id',
                        'token' => 'plugins.facebook-feed.fb_settings.token',
                        'limit' => 'plugins.facebook-feed.fb_settings.limit'
                    ],
                    'fb' => [
                        'headline' => 'plugins.facebook-feed.fb.headline',
                        'postLinkTitle' => 'plugins.facebook-feed.fb.postLinkTitle',
                        'postLinkAlt' => 'plugins.facebook-feed.fb.postLinkAlt',
                        'mainLinkTitle' => 'plugins.facebook-feed.fb.mainLinkTitle',
                        'mainLinkAlt' => 'plugins.facebook-feed.fb.mainLinkAlt',
                        'imgFallback' => 'plugins.facebook-feed.fb.imgFallback',
                        'imgFallbackSelect' => 'plugins.facebook-feed.fb.imgFallbackSelect',
                        'imgFallbackAlt' => 'plugins.facebook-feed.fb.imgFallbackAlt',
                        'imgFallbackTitle' => 'plugins.facebook-feed.fb.imgFallbackTitle'
                    ]
                ],
                'feed' => [
                ...
                'social-media-links' => [
                    ...
                    'social_pages' => [
                        'pages' => [
                            ...
                            'youtube' => [
                                'icon' => 'plugins.social-media-links.social_pages.pages.youtube.icon',
                                'url' => 'plugins.social-media-links.social_pages.pages.youtube.url',
                                'title' => 'plugins.social-media-links.social_pages.pages.youtube.title',
                                'position' => 'plugins.social-media-links.social_pages.pages.youtube.position'
                            ],
                            'telegram' => [
                                'icon' => 'plugins.social-media-links.social_pages.pages.telegram.icon',
                                'url' => 'plugins.social-media-links.social_pages.pages.telegram.url',
                                'title' => 'plugins.social-media-links.social_pages.pages.telegram.title',
                                'position' => 'plugins.social-media-links.social_pages.pages.telegram.position'
                            ]
                        ]
                    ]
                ],
            ...
            'themes' => [
                'mytheme' => [
                    ...
                    'production-mode' => 'themes.mytheme.production-mode',
                    'grid-size' => 'themes.mytheme.grid-size',
                    'custom_logo' => 'themes.mytheme.custom_logo',
                    'custom_logo_mobile' => 'themes.mytheme.custom_logo_mobile',
                    'header-fixed' => 'themes.mytheme.header-fixed',
                    'header-animated' => 'themes.mytheme.header-animated',
                    'header-dark' => 'themes.mytheme.header-dark',
                    'header-transparent' => 'themes.mytheme.header-transparent',
                    'sticky-footer' => 'themes.mytheme.sticky-footer',
                    'blog-page' => 'themes.mytheme.blog-page',
                    'blog_page_hero_classes' => 'themes.mytheme.blog_page_hero_classes',
                    'spectre' => [
                        'exp' => 'themes.mytheme.spectre.exp',
                        'icons' => 'themes.mytheme.spectre.icons'
                    ],
                    'displaycustommenus' => [
                    ...
                    'menu' => [
                        '*' => [
                            'text' => 'themes.mytheme.menu.*.text',
                            'icon' => 'themes.mytheme.menu.*.icon',
                            'url' => 'themes.mytheme.menu.*.url',
                            'target' => 'themes.mytheme.menu.*.target'
                        ]
                    ],
